...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/gozde/aruco_ws/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/gozde/aruco_ws/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/gozde/aruco_ws/install)
...
if(NOT "/home/gozde/aruco_ws/src/cv_camera/include;/usr/include/opencv4 " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/gozde/aruco_ws/src/cv_camera/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gozde/aruco_ws/src/cv_camera/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gozde/aruco_ws/devel/lib;/opt/ros/noetic/lib)
